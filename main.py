...
class App(tk.Tk):
    ...
    def run_query_roles(self,sheet):
        ...
        LEFT JOIN roles ON roles_managed_policies.rolearn=roles.arn
        ...
        LEFT JOIN roles ON roles_inline_policies.rolearn=roles.arn
